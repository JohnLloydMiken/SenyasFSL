...
const UserStreak: React.FC<streakProps> = ({streakCount = 1, protectionCount = 1}) =>{
          ...
          <View className='bg-[#FAF3E0] w-11/12 rounded-xl p-8  relative '>
                     <View className='absolute left-[38%] -top-28 z-0'>
                      ...
                      <MaskedView
                        ...
                        maskElement={
                                    <Text className="text-3xl font-PoppinsBold ">{streakCount}</Text>
                                    } >
                          <LinearGradient
                            ...
                            >
                              ...
                              <Text style={{ opacity: 0 }} className='text-3xl font-PoppinsBold  '>{streakCount}</Text>
                          </LinearGradient>
                      </MaskedView>
                      ...
                      <View>
                        <View className='flex flex-row justify-center items-center absolute -right-2 -top-4'>
                           <Image source={require('../assets/images/sunProtection.png')}/>
                            <MaskedView
                              maskElement={
                                <Text className="text-3xl font-PoppinsBold ">{protectionCount}</Text>
                                          }
                                           >
                                <LinearGradient
                                  ...
                                  start={{ x: 0, y: 0 }}
                                           ...
                                           >
                                     {/* Invisible text only to preserve size */}
                                  <Text style={{ opacity: 0 }} className='text-3xl font-PoppinsBold  '>{protectionCount}</Text>
                                </LinearGradient>
                            </MaskedView>
                        </View>
                         {/* Streak Count */}
                        <Text className='text-center font-PoppinsBold text-3xl my-8'>{streakCount} Day Streak!</Text>
