...
// components/main_interface/treasure/InventoryInTreasure.tsx
...
import { TreasurePreview } from "./items"; // ✅ Imports your UI component
...
const InventoryInTreasure: React.FC<InventoryProps> = React.memo(
...
export default InventoryInTreasure;
